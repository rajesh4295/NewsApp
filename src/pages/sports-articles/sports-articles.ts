...
/**
 * Generated class for the SportsArticlesPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-sports-articles',
  templateUrl: 'sports-articles.html',
})
export class SportsArticlesPage {
  ...
  ngOnInit(){
    ...
    getTopHeadLines(){
      this.newsService.getSportsArticleFeed().subscribe((data) =>{
