...
/**
 * Generated class for the WhatsappVideosPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-whatsapp-videos',
  templateUrl: 'whatsapp-videos.html',
})
export class WhatsappVideosPage {
  ...
  getData(){
    ...
    this.service.getWhatsappVideoFeed().subscribe((data)=> {     
        // alert("success")
            this.rssObj=data;
