...
@IonicPage()
@Component({
  selector: 'page-entertainment-articles',
  templateUrl: 'entertainment-articles.html',
})
export class EntertainmentArticlesPage {
  ...
  ngOnInit(){
    ...
    getTopHeadLines(){
      this.newsService.getEntertainmentArticleFeed().subscribe((data) =>{
