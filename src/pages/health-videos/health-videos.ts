...
/**
 * Generated class for the HealthVideosPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-health-videos',
  templateUrl: 'health-videos.html',
})
export class HealthVideosPage {
  ...
  getData(){
    ...
    this.service.getHealthVideoFeed().subscribe((data)=> {     
        // alert("success")
            this.rssObj=data;
