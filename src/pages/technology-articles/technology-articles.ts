...
/**
 * Generated class for the TechnologyArticlesPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-technology-articles',
  templateUrl: 'technology-articles.html',
})
export class TechnologyArticlesPage {
  ...
  ngOnInit(){
    ...
    getTopHeadLines(){
      this.newsService.getTechnologyArticleFeed().subscribe((data) =>{
