...
/**
 * Generated class for the FunnyVideosPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-funny-videos',
  templateUrl: 'funny-videos.html',
})
export class FunnyVideosPage {
  ...
  getData(){
    ...
    this.service.getFunnyVideoFeed().subscribe((data)=> {     
        // alert("success")
            this.rssObj=data;
