...
/**
 * Generated class for the TechVideosPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-tech-videos',
  templateUrl: 'tech-videos.html',
})
export class TechVideosPage {
  ...
  getData(){
    ...
    this.service.getTechVideoFeed().subscribe((data)=> {     
        // alert("success")
            this.rssObj=data;
